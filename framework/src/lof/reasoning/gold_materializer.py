    ...
    def materialize(self, result: ReasoningResult) -> list[dict[str, Any]]:
        ...
        for f in result.facts:
            ...
            if eid not in entities:
                entities[eid] = {"id": eid, "name": eid.capitalize(), "fields": [], "operations": [], "relations": [], "projections": []}  # noqa: E501
            ...
            if f.predicate == "field_type" and len(f.args) >= 2:
                ...
                if f.key in fact_map:
                    for rel_fact_key in fact_map:
                        ...
                        if rfk.predicate == "required" and len(rfk.args) >= 2 and rfk.args[0] == f.args[0]:  # noqa: E501
                            field["required"] = True
        ...
        for eid, ent in entities.items():
            ...
            if not any(f.get("primary") for f in ent["fields"]):
                ent["fields"].insert(0, {"name": "id", "type": "uuid",  # noqa: E501
